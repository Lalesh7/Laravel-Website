    ...
    <div id="blog">
        <div id="header-hero-container">
            ...
            <section id="hero">
                ...
                <div class="hero-text">
                    <h1>Blog</h1>
                    <h2> <a href="index.html" class="tab"> Home </a> / Blog</h2>
                </div>
            </section>
        </div>
    ...
    <div class="blogs">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h4> <a href="blog_1.html">Apple's AR/VR Headset may include video content created by Hollywood directors</a></h4>
                ...
                <div class="card-user">
                    <img src="images/content writer.jpg" alt="user1">
                    <div class="user-info">
                        <h5>Sabbu</h5>
        ...
        <div class="card">
            <div class="card-header">
                <img src="images/tourist-sitting-phu-sub-lek-viewpoint-sunset-lopburi-thailand.jpg" alt="Hiking">
            </div>
            <div class="card-body">
                ...
                <div class="card-user">
                    <img src="images/hr.jpg" alt="user2">
                    <div class="user-info">
                        <h5>Harshha</h5>
        ...
        <div class="card">
            <div class="card-header">
                <img src="images/aerial-shot-boat-spiti-river-india.jpg" alt="Lake">
            </div>
            <div class="card-body">
                <span class="tag tag-travel">Travel</span>
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi voluptatem asperiores quidem atque autem?Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias asperiores molestia</p>
                <div class="card-user">
                    <img src="images/graphic designer.jpg" alt="user3">
                    <div class="user-info">
                        <h5>Bhim Vai</h5>
